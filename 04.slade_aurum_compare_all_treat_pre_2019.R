...
## Load dataset
dataset_formatted <- set_up_data_sglt2_glp1(dataset.type="full.cohort") %>%
...
pdf(height = 6, width = 19, paste0(output_path, "/comparison_pre_2019.pdf"))
plot_estimates
plot_estimates_sex
dev.off()

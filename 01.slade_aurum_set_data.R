...
set_up_data_sglt2_glp1 <- function(dataset.type, diagnosis = FALSE) {
  ...
  if (!(dataset.type %in% c("synthetic", "full.cohort", "ps.model.train", "ps.model.test", "hba1c.train", "hba1c.test", "weight.dataset", "discontinuation.dataset", "egfr.dataset", "ckd.dataset" , "cvd.dataset", "hf.dataset", "no_co.dataset", "semaglutide.dataset", "micro_comp.dataset", "retinopathy.dataset", "insulin.dataset"))) {
    stop("'dataset.type' must be one of: synthetic / full.cohort / ps.model.train / ps.model.test / hba1c.train / hba1c.test / weight.dataset / discontinuation.dataset / egfr.dataset / ckd.dataset / cvd.dataset / hf.dataset / no_co.dataset / semaglutide.dataset / micro_comp.dataset / retinopathy.dataset / insulin.dataset")
  }
